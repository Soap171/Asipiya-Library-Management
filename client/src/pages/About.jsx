    ...
    <div className="min-h-screen bg-white text-black dark:bg-gray-900 dark:text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-semibold mb-4 font-playfair" style={{ fontFamily: "'Playfair Display', serif" }}>About Us</h1>
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 font-poppins" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="grid sm:grid-cols-3 gap-8 mb-16">
          <div className="flex flex-col items-center p-8 bg-gray-300 dark:bg-gray-800 text-black dark:text-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer hover:shadow-lg hover:-translate-y-1 hover:scale-105 hover:transition-transform">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-semibold mb-6 text-center font-playfair" style={{ fontFamily: "'Poppins', sans-serif" }}>Meet the Team</h2>
          <div className="flex justify-center gap-12 flex-wrap cursor-pointer">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-semibold mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>What Our Users Say</h2>
        ...
        <div className="bg-gray-100 dark:bg-gray-800 py-12 px-6 rounded-xl max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="p-4 bg-gray-300 dark:bg-gray-700 shadow rounded-lg cursor-pointer">
        ...
        <div className="text-center mt-16">
          <h2 className="text-3xl font-semibold mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>Need Help?</h2>
          <p className="text-lg text-gray-600 dark:text-gray-300">Reach out to us for any queries.</p>
          <Link to="/contact">
          <button className="mt-4 px-6 py-3 bg-white text-black rounded-lg shadow-lg">Contact Us</button>
          </Link>       
        </div>
      </div>
    </div>
